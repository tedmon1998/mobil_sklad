...
public class AllProduct_Povorot extends ListActivity implements View.OnClickListener {
    ...
    private static String url_all_products = HOST.host+"PHP/admin/BD_CONNECT.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(AllProduct_Povorot.this, "Склад продуктов", Toast.LENGTH_SHORT).show();
////////////////////////////////////////////////////////////////////
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllProduct_Povorot.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            AllProduct_Povorot.this, productsList,
