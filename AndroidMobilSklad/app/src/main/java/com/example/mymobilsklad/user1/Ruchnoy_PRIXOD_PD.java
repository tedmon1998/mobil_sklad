...
import com.example.mymobilsklad.admin.NewPD;
import com.example.mymobilsklad.admin.RasxodPD;
...
public class Ruchnoy_PRIXOD_PD extends Activity {
    ...
    private static final String url_update_product = HOST.host+"PHP/users/create_ruchnoy_prixod.php";
    ...
    private static final String TAG_USERESES = "userses";
...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    class GetProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Ruchnoy_PRIXOD_PD.this);
            pDialog.setMessage("Загрузка информации о продукте. Пожалуйста подождите...");
    ...
    class SaveProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Ruchnoy_PRIXOD_PD.this);
            pDialog.setMessage("Сохранение товара ...");
            pDialog.setIndeterminate(false);
            pDialog.setCancelable(true);
            pDialog.show();
        }
        ...
        protected String doInBackground(String[] args) {
            ...
            //noinspection deprecation
            params.add(new BasicNameValuePair(TAG_USERESES, encode(userses)));
            // отправляем измененные данные через http запрос
