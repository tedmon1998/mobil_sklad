...
public class AllProdano_Pers extends ListActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(AllProdano_Pers.this, "Порядок: по персоналу", Toast.LENGTH_SHORT).show();
...
////////////////////////////////////////////////////////////////////
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllProdano_Pers.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            AllProdano_Pers.this, productsList,
