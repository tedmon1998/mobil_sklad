...
public class AllProduct extends ListActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(AllProduct.this, "Склад продуктов", Toast.LENGTH_SHORT).show();
