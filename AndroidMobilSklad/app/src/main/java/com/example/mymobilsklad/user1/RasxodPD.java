...
public class RasxodPD extends AppCompatActivity implements View.OnClickListener {
    ...
    Button button_rasxod;
    Button scansc;
    TextView session_text;

    private static String url_create_rasxod = HOST.host+"PHP/users/rasxod.php";
...
///////////////////////////////////////////////////////////////////////////////////////////
        ...
        button_rasxod = (Button) findViewById(R.id.button_ruchnoy);
        button_rasxod.setOnClickListener(this);
    ...
    public void clear_kol_vvod(View view) {
        text_del.setText("");
    }
    /**
