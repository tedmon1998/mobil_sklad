...
public class AllProdano_Pers_Povorot extends ListActivity implements View.OnClickListener {
    ...
    private static String url_all_products = HOST.host+"PHP/admin/AllProdano_user.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(AllProdano_Pers_Povorot.this, "Порядок: по персоналу", Toast.LENGTH_SHORT).show();
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllProdano_Pers_Povorot.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            AllProdano_Pers_Povorot.this, productsList,
    ...
    private void AllProdano_Povorot() {

        SharedPreferences sPref = getPreferences(MODE_PRIVATE);
        String saveText = sPref.getString(TAG_SESSION, "");
        Intent intent = new Intent(this, AllProdano_Povorot.class);
        startActivity(intent);
    ...
    private void AllProdano_Pers() {

        SharedPreferences sPref = getPreferences(MODE_PRIVATE);
        String saveText = sPref.getString(TAG_SESSION, "");
        Intent intent = new Intent(this, AllProdano_Pers.class);
        intent.putExtra("name_user", session_text.getText().toString());
        startActivity(intent);
        finish();
