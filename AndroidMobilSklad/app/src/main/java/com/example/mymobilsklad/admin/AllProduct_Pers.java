...
public class AllProduct_Pers extends ListActivity implements View.OnClickListener {
    ...
    private static String url_all_products_name = HOST.host+"PHP/admin/AllProduct_user.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(AllProduct_Pers.this, "Порядок: по персоналу", Toast.LENGTH_SHORT).show();
...
////////////////////////////////////////////////////////////////////
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllProduct_Pers.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            AllProduct_Pers.this, productsList,
