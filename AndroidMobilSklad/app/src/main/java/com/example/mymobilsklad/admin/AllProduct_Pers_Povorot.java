...
public class AllProduct_Pers_Povorot extends ListActivity implements View.OnClickListener {
    ...
    private static String url_all_products = HOST.host+"PHP/admin/AllProduct_user.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(AllProduct_Pers_Povorot.this, "Порядок: по персоналу", Toast.LENGTH_SHORT).show();
////////////////////////////////////////////////////////////////////
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllProduct_Pers_Povorot.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            AllProduct_Pers_Povorot.this, productsList,
