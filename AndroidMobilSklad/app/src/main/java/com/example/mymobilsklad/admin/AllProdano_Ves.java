...
public class AllProdano_Ves extends ListActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(AllProdano_Ves.this, "Порядок: по весу", Toast.LENGTH_SHORT).show();
////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllProdano_Ves.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            AllProdano_Ves.this, productsList,
