...
public class AllProdano_Name extends ListActivity implements View.OnClickListener {
...
////////////////////////////////////////////////////////////////////
        Toast.makeText(AllProdano_Name.this, "Порядок: по продукту", Toast.LENGTH_SHORT).show();
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllProdano_Name.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            AllProdano_Name.this, productsList,
