...
public class AllProduct_Name_Povorot extends ListActivity implements View.OnClickListener {
    ...
    private static String url_all_products = HOST.host+"PHP/admin/AllProduct_name.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_product_povorot);
        ///////////////////////////////////////////////////////////////////////////////////////////
        ...
        Toast.makeText(AllProduct_Name_Povorot.this, "Порядок: по продукту", Toast.LENGTH_SHORT).show();
////////////////////////////////////////////////////////////////////
        ...
        updated_at = (Button) findViewById(R.id.updated_at);
        updated_at.setOnClickListener(this);
        /////////////////////////////////////////////
        ...
        updated_at.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                AllProduct_Povorot();
                return true;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.pers:
                AllProduct_Pers_Povorot();
                break;

            case R.id.ves:
                AllProduct_Ves_Povorot();
                break;
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllProduct_Name_Povorot.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            AllProduct_Name_Povorot.this, productsList,
    ...
    private void AllProduct_Name() {

        SharedPreferences sPref = getPreferences(MODE_PRIVATE);
        String saveText = sPref.getString(TAG_SESSION, "");
        Intent intent = new Intent(this, AllProduct_Name.class);
        intent.putExtra("name_user", session_text.getText().toString());
        startActivity(intent);
    ...
    private void AllProduct_Povorot() {
        SharedPreferences sPref = getPreferences(MODE_PRIVATE);
        String saveText = sPref.getString(TAG_SESSION, "");
        Intent intent = new Intent(this, AllProduct_Povorot.class);
        intent.putExtra("name_user", session_text.getText().toString());
        startActivity(intent);
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void AllProduct_Pers_Povorot() {
        SharedPreferences sPref = getPreferences(MODE_PRIVATE);
        String saveText = sPref.getString(TAG_SESSION, "");
        Intent intent = new Intent(this, AllProduct_Pers_Povorot.class);
        intent.putExtra("name_user", session_text.getText().toString());
        startActivity(intent);
    }

    private void AllProduct_Ves_Povorot() {
        SharedPreferences sPref = getPreferences(MODE_PRIVATE);
        String saveText = sPref.getString(TAG_SESSION, "");
        Intent intent = new Intent(this, AllProduct_Ves_Povorot.class);
        intent.putExtra("name_user", session_text.getText().toString());
        startActivity(intent);
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////
