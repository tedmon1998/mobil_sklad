...
public class Obshee extends ListActivity implements View.OnClickListener {
    ...
    private static String url_all_products = HOST.host+"PHP/admin/Obshee.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
            setContentView(R.layout.obshee);
        }
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            setContentView(R.layout.obshee_povorot);
        }
        ...
        Toast.makeText(Obshee.this, "Общий список продуктов", Toast.LENGTH_SHORT).show();
////////////////////////////////////////////////////////////////////
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Obshee.this);
