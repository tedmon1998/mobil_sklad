...
$query="SELECT name, kod, ves, created_at, updated_at FROM `products` WHERE gorc='elq' and name_lev='' and MONTH(`updated_at`) = MONTH(NOW()) AND YEAR(`updated_at`) = YEAR(NOW()) ORDER BY updated_at DESC";
