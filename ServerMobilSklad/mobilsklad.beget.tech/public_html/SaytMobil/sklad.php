...
z-index: 9999; position: sticky; top: -1%; width: 10.2%;left:0%;background: rgba(999, 999, 999, 0.5);;color:#000000;
}

  #b{


z-index: 9999; position: sticky; top: -1%; width:10.85%;left:10.15%;background: rgba(999, 999, 999, 0.5);;color:#000000;
}
  #c{


z-index: 9999; position: sticky; top: -1%; width:10.2%;left:20.95%;background: rgba(999, 999, 999, 0.5);;color:#000000;
}
  #d{


z-index: 9999; position: sticky; top: -1%; width:29.1%;left:31.09%;background: rgba(999, 999, 999, 0.5);;color:#000000;
}
  #e{


z-index: 9999; position: sticky; top: -1%; width:29.2%;left:60.1%;background: rgba(999, 999, 999, 0.5);;color:#000000;
}
  #f{
      


z-index: 9999; position: sticky; top: -1%; width:12%;left:89.23%;background: rgba(999, 999, 999, 0.5);;color:#000000;
}
...
$query="
SELECT pid, name, COUNT(*) kol, SUM(ves) ves, kod
FROM `products`WHERE gorc='mutq' and name_lev =''
GROUP BY name HAVING kol > 0";
$result=mysqli_query($link,$query);
echo "<table align=center id='kol'  class='table table-bordered' style='width:40%;';>";
echo "<tr align=center>";
echo "<td>"."Имя продукта"."</td>";
echo "<td>"."Код продукта"."</td>";
echo "<td>"."Количество"."</td>";
echo "<td>"."Вес продукта"."</td>";
echo "</tr>";
...
echo "<td id='b'>"."Код продукта"."</td>";
echo "<td id='c'>"."Вес продукта"."</td>";
echo "<td id='d'>"."Дата добавления"."</td>";
echo "<td id='e'>"."Дата изменения"."</td>";
echo "<td id='f'>"."Пользователь"."</td>";
echo "</tr>";
while($row = mysqli_fetch_assoc($result)){
echo "<tr align=center>";
echo "<td id='aa'>".$row[name]."</td>";
echo "<td id='ab'>".$row[kod]."</td>";
echo "<td id='ac'>".$row[ves]."</td>";
echo "<td id='ad'>".$row[created_at]."</td>";
echo "<td id='ae'>".$row[updated_at]."</td>";
echo "<td id='af'>".$row[user]."</td>";
echo "</tr>";
}
}
echo "</table>";
...
<div style="display:none; top: 93%" class="glaviy" id="glaviy"></div>
...
$('#glaviy,#nav_up,#nav_down').stop().animate({'opacity':'0.2'});
});
$(window).bind('scrollstop', function(){
$('#glaviy,#nav_up,#nav_down').stop().animate({'opacity':'1'});
});
