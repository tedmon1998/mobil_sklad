...
$query="SELECT name, kod, ves, created_at, updated_at FROM `products` WHERE gorc='mutq'  and  name_lev='' and updated_at >= date_sub(now(), INTERVAL 1 HOUR) ORDER BY updated_at DESC";
