...
if(isset($_POST['submit']))
{
    ...
    $query = mysqli_query($link, "SELECT user_id FROM buxgalter WHERE user_login='".mysqli_real_escape_string($link, $_POST['login'])."'");
    ...
    if(count($err) == 0)
    {
        ...
        $buxgalter = md5(md5(trim($_POST['buxgalter'])));

        mysqli_query($link,"INSERT INTO buxgalter SET user_login='".$login."', user_password='".$buxgalter."'");
                    if(true){
...
<meta charset="utf-8">
    <div id="center">
<form method="POST">
 <input name="login" id="dlina" type="text" required placeholder="Логин" class = "ugl"><br><br>
 <input name="buxgalter"id="dlina" type="password" required placeholder="Пароль" class = "ugl"><br><br>
<a http-equiv="refresh" content="5"><input name="submit" type="submit" value="Зарегистрировать" id="input" id = "dlina"></a><br><br>
...
<button onclick="window.location='./get_all_pass_buxgalter.php'" name="sbros" id = "dlina" style="color: #ffffff;">Сбросить</button><br><br>
