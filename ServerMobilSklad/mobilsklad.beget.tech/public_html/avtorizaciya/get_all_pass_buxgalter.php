...
echo "<td bgcolor='#ffffff'; id='ramka'><a href='./get_all_pass_buxgalter.php?id_pa=$row[user_id]'>".$row[user_login]." </a></td>";
echo "</tr>";
...
$pid = $_GET[id_pa];
    ...
    $link = mysqli_connect($host, $user, $password, $database);
    $query = ("UPDATE `buxgalter` SET  user_password = '3675ac5c859c806b26e02e6f9fd62192' WHERE user_id = $pid");
    $result=mysqli_query($link,$query);
    ...
    if ($result) {
        ...
        echo  "<script>alert('Ваш Пароль: qwe');</script>";
...
<p><a href="./buxgalter.php" id='glav'></a></p>
