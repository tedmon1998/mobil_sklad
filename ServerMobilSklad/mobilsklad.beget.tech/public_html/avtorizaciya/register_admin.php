...
if(isset($_POST['submit']))
{
    ...
    $query = mysqli_query($link, "SELECT user_id FROM admin WHERE user_login='".mysqli_real_escape_string($link, $_POST['login'])."'");
    ...
    if(count($err) == 0)
    {
        ...
        $admin = md5(md5(trim($_POST['admin'])));


        mysqli_query($link,"INSERT INTO admin SET user_login='".$login."', user_password='".$admin."'");
        if(true){
...
<input name="admin" id="dlina" type="password" required placeholder="Пароль" class = "ugl"><br><br>
<a http-equiv="refresh" content="5"><input name="submit" type="submit" id="input" value="Зарегистрировать" id = "dlina"></a><br><br>
</form>

<button onclick="window.location='./get_all_pass.php'" id = "dlina" style="color: #ffffff;" >Сбросить</button><br><br><br>
