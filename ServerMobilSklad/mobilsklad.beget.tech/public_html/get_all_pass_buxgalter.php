...
$pid = $_GET[id_pa];
    ...
    $link = mysqli_connect($host, $user, $password, $database);
    $query = ("UPDATE `admin` SET  user_login = 'admin', user_password = 'c3284d0f94606de1fd2af172aba15bf3' WHERE user_id = $pid");
    $result=mysqli_query($link,$query);
    if ($result) {
        // successfully updated

        echo  "<script>alert('Ваш Логин: admin \\nВаш Пароль: admin');</script>";
